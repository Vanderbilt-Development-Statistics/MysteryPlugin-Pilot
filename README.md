...
Your objective for this study is straightforward: **complete the programming assignment while approaching the task as creatively as possible.** Feel free to use any external resources you'd like — search engines, AI tools, collaboration with friends, Stack Overflow, etc. The goal is to solve the problems using whatever approach comes naturally to you, so we can study different development patterns.
