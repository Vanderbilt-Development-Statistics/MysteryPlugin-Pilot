...
| `version` matches plugin source | `1.0.6` — matches `gradle.properties` |
...
### 6. Student Project Template (project4.zip) — PASS

| Check | Result |
|-------|--------|
| `externalDependencies.xml` in `project4/.idea/` | Present — IDE auto-prompts for plugin installation |
